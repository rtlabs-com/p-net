...
typedef enum pnal_eth_mau
{
   ...
   PNAL_ETH_MAU_COPPER_10BaseTX_HALF_DUPLEX = 0x0A,
   PNAL_ETH_MAU_COPPER_10BaseTX_FULL_DUPLEX = 0x0B,
   ...
   PNAL_ETH_MAU_FIBER_10000BaseR = 0x21,
   PNAL_ETH_MAU_COPPER_10000BaseT = 0x36,
   PNAL_ETH_MAU_COPPER_2500BaseT = 0x67,
   PNAL_ETH_MAU_COPPER_5000BaseT = 0x68,
   PNAL_ETH_MAU_FIBER_2500BaseX = 0x6E,
   PNAL_ETH_MAU_FIBER_5000BaseR = 0x70,
} pnal_eth_mau_t;
