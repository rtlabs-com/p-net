...
#define RPC_TOWER_FLOOR_COUNT 5
...
#define RPC_EPM_ANNOTATION_OFFSET 0
#define RPC_EPM_ANNOTATION_LENGTH 64
#define RPC_EPM_FLOOR_LENGTH      75
 ...
 * that indicates the portâ€™s description. If RFC 2863
