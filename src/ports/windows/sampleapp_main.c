...
int main (void)
{
   ...
   appdata.main_timer = os_timer_create (APP_TICK_INTERVAL_US, main_timer_tick, NULL, false);
   gp_appdata = &appdata;
   ...
   strncpy (pnet_default_cfg.if_cfg.main_port.if_name,appdata.arguments.eth_interface,PNET_INTERFACE_NAME_MAX_SIZE);
   memcpy (pnet_default_cfg.if_cfg.main_port.eth_addr.addr,macbuffer.addr,sizeof (pnet_ethaddr_t));

   strncpy (pnet_default_cfg.if_cfg.ports[0].phy_port.if_name,appdata.arguments.eth_interface,PNET_INTERFACE_NAME_MAX_SIZE);
   memcpy (pnet_default_cfg.if_cfg.ports[0].phy_port.eth_addr.addr, macbuffer.addr, sizeof (pnet_ethaddr_t));
