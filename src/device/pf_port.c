...
pf_mediatype_values_t pf_port_get_media_type (pnal_eth_mau_t mau_type)
{
   ...
   case PNAL_ETH_MAU_COPPER_10000BaseT:
   case PNAL_ETH_MAU_COPPER_5000BaseT:
   case PNAL_ETH_MAU_COPPER_2500BaseT:
   ...
   case PNAL_ETH_MAU_FIBER_10000BaseR:
   case PNAL_ETH_MAU_FIBER_2500BaseX:
   case PNAL_ETH_MAU_FIBER_5000BaseR:
