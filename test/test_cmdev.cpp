...
TEST_F (CmdevTest, CmdevCheckNoStraddle)
{
   ...
   {
      EXPECT_EQ (0, pf_cmdev_check_no_straddle(start_a, length_a, start_b, length_b));
      EXPECT_EQ (0, pf_cmdev_check_no_straddle(start_b, length_b, start_a, length_a));
   }
   for (start_b = 701; start_b <= 1499; start_b++)
   {
      EXPECT_EQ (-1, pf_cmdev_check_no_straddle(start_a, length_a, start_b, length_b));
      EXPECT_EQ (-1, pf_cmdev_check_no_straddle(start_b, length_b, start_a, length_a));
   }
   ...
   EXPECT_EQ (0, pf_cmdev_check_no_straddle(start_a, length_a, 0xFFFF,  length_b));
