...
#define TEST_SUBMOD_DAP_INTERFACE_1_IDENT          0x00008000     /* For use in subslot 0x8000 */
#define TEST_SUBMOD_DAP_INTERFACE_1_PORT_0_IDENT   0x00008001     /* For use in subslot 0x8001 */
...
typedef struct app_data_for_testing_obj
{
   ...
   cfg_submodules_t        available_submodule_types[TEST_MAX_NUMBER_AVAILABLE_SUBMODULE_TYPES];
   bool                    init_done;
   uint16_t                read_fails;
