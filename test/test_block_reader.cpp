...
TEST_F (BlockReaderTest, BlockReaderTestGetBits)
{
   ...
   EXPECT_EQ (         0ul, pf_get_bits(0xFFFFFFFF, 1, 32));  /* Illegal length and position combination*/
   ...
   EXPECT_EQ (         0ul, pf_get_bits(0xFFFFFFFF, 31,  2));  /* Illegal length and position combination*/
   EXPECT_EQ (         0ul, pf_get_bits(0xFFFFFFFF, 31, 32));  /* Illegal length and position combination*/
   ...
   EXPECT_EQ (         0ul, pf_get_bits(0xFFFFFFFF, 32, 33));  /* Illegal position and illegal length */

   EXPECT_EQ (         0ul, pf_get_bits(0xFFFFFFFF, 0xFF, 0xFF));  /* Illegal position and illegal length */
   ...
   EXPECT_EQ (         0ul, pf_get_bits(0x00000010, 30, 3));  /* Illegal length and position combination*/
   EXPECT_EQ (         0ul, pf_get_bits(0x00000010, 31, 3));  /* Illegal length and position combination*/
   ...
   EXPECT_EQ (         0ul, pf_get_bits(0x80000000, 30, 3));  /* Illegal length and position combination*/
   EXPECT_EQ (         0ul, pf_get_bits(0x80000000, 31, 3));  /* Illegal length and position combination*/
